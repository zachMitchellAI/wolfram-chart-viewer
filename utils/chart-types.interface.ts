...
export interface BarChartDataset<
  TData = number | [number, number],
> extends DeepPartial<BarControllerDatasetOptions> {
  type: "bar";
  data: TData[];
  label?: string;
...
export interface LineChartDataset<
  TData = ScatterDataPoint | number,
> extends DeepPartial<LineControllerDatasetOptions> {
  type: "line";
  data: TData[];
  label?: string;
  borderColor?: string | string[];
...
export interface ScatterChartDataset<
  TData = ScatterDataPoint,
> extends DeepPartial<ScatterControllerDatasetOptions> {
  type: "scatter";
  data: TData[];
  label?: string;
  backgroundColor?: string | string[];
...
export interface BubbleChartDataset<
  TData = BubbleDataPoint,
> extends DeepPartial<BubbleControllerDatasetOptions> {
  type: "bubble";
  data: TData[];
  label?: string;
  backgroundColor?: string | string[];
...
export interface PieChartDataset<
  TData = number,
> extends DeepPartial<PieControllerDatasetOptions> {
  type: "pie";
  data: TData[];
  label?: string;
  backgroundColor?: string | string[];
...
export interface DoughnutChartDataset<
  TData = number,
> extends DeepPartial<DoughnutControllerDatasetOptions> {
  type: "doughnut";
  data: TData[];
  label?: string;
  backgroundColor?: string | string[];
...
export interface PolarAreaChartDataset<
  TData = number,
> extends DeepPartial<PolarAreaControllerDatasetOptions> {
  type: "polarArea";
  data: TData[];
  label?: string;
  backgroundColor?: string | string[];
...
export interface RadarChartDataset<
  TData = number,
> extends DeepPartial<RadarControllerDatasetOptions> {
  type: "radar";
  data: TData[];
  label?: string;
  backgroundColor?: string | string[];
...
export type ChartDatasetByType<TType extends ChartTypeLiteral> =
  TType extends "bar"
    ...
    : TType extends "line"
      ? LineChartDataset
      : TType extends "scatter"
        ? ScatterChartDataset
        : TType extends "bubble"
          ? BubbleChartDataset
          : TType extends "pie"
            ? PieChartDataset
            : TType extends "doughnut"
              ? DoughnutChartDataset
              : TType extends "polarArea"
                ? PolarAreaChartDataset
                : TType extends "radar"
                  ? RadarChartDataset
                  : never;
...
export interface ChartDataByType<
  TType extends ChartTypeLiteral,
  TLabel = string,
> {
  labels?: TLabel[];
...
export function isChartConfigurationWithType<TType extends ChartTypeLiteral>(
  config:
    ChartConfiguration<TType> | ChartConfigurationCustomTypesPerDataset<TType>,
